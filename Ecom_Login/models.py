...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    is_staff = models.BooleanField(
        text_lazy('Staff'), default=False,
        help_text=text_lazy('Designates whether the user can log in the site')
    )
    
    is_active = models.BooleanField(
        text_lazy('active'),
        default=True, 
        help_text=text_lazy('Designates whether this user should be treated as active')
    )
